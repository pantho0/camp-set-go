  ...
  return (
    <Container>
      <section className="bg-transparent">
        <div className="mx-auto max-w-screen-xl px-4 py-10 sm:px-6 lg:px-8 lg:py-16">
          <h2 className="text-center text-3xl font-medium tracking-tight text-gray-900 sm:text-5xl">
